...
$header[] = "X-Location: -7.254693,112.754554";
$header[] = "X-Location-Accuracy: 3.0";
if ($pin):
$header[] = "pin: $pin";
    endif;
...
$header = substr($response, 0, curl_getinfo($c, CURLINFO_HEADER_SIZE));<?php<?https://github.com/ramabna/dorjekjuni
...
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location: -6.925846,107.618357";
$header[] = "X-Location-Accuracy: 3.0";
if ($pin):
$header[] = "pin: $pin";
    endif;
